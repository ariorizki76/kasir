...
class PelangganController extends Controller {
    ...
    public static function login(Request $request){
    	...
    	if($row){
            $pelanggan = Pelanggan::where('username_pelanggan', $username_pelanggan)->where('password_pelanggan', $password_pelanggan)->get();
    ...
    public function register(Request $request){
        ...
        $pelanggan = Pelanggan::where('username_pelanggan', $data['username_pelanggan'])->where('password_pelanggan', $data['password_pelanggan'])->get();
