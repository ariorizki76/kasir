...
<link href=" {{ asset('ela/css/lib/sweetalert/sweetalert.css') }}" rel="stylesheet">
        <a href="{{URL('admin/hidangan/create')}}" class="btn btn-success">Tambah Hidangan</a>
        ...
        <div class="card">
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="row">
                                            <a href="{{URL('admin/hidangan/'.$makanan->id_hidangan.'/edit')}}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                            
                                            <form action="{{URL('admin/hidangan/'.$makanan->id_hidangan)}}" method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE')}}
                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                      ...
                                      <div class="card-body">
                                        ...
                                        <div class="row">
                                            <a href="{{URL('admin/hidangan/'.$minuman->id_hidangan.'/edit')}}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                            <form action="{{URL('admin/hidangan/'.$minuman->id_hidangan)}}" method="POST">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE')}}
                                                <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                            </form>
                ...
                <script type="text/javascript">
                    $('form').submit(function(e){
                        ...
                        e.preventDefault();
                        swal({
                                title: "Yakin ingin menghapus hidangan?",
                                text: "Hidangan yang dihapus tidak bisa dikembalikan",
                                type: "warning",
