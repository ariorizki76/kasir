...
@section('content')
                    ...
                    <a href="{{URL('admin/meja/create')}}" class="btn btn-success">Tambah Meja</a>
                ...
                <div class="table-responsive m-t-40">
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$meja->no_meja}}</td>
                                <td>{{$meja->cafe_meja}}</td>
                                <td>
                                    <form action="{{URL('admin/meja/'.$meja->id_meja)}}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE')}}
        ...
        <script type="text/javascript">
            $('form').submit(function(e){
                ...
                e.preventDefault();
                swal({
                        title: "Yakin ingin menghapus meja?",
                        text: "Meja yang dihapus tidak bisa dikembalikan",
                        type: "warning",
