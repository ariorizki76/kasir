...
<div class="col-lg-12">
    <div class="card" style="background: #f5f5f5">
        <div class="basic-form">
                    <a href="{{URL('admin/pelanggan/create')}}" class="btn btn-success">Tambah Pelanggan</a>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL('admin/pelanggan/'.$pelanggan->id_pelanggan.'/edit')}}" class="btn btn-primary">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{URL('admin/pelanggan/'.$pelanggan->id_pelanggan)}}" method="POST">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE')}}
