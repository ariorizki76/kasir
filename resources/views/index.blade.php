        ...
        <div id="team" class="col-md-12" style="background-image:url({{ asset('resto/images/slide_3.jpg')}});background-size: cover;padding-bottom: 50px">
            <div class="container">
                ...
                <div class="row justify-content-center" style="padding: 15px">
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/ario.jpg')}}" title="Ario" class="rounded img-responsive" style="cursor: pointer;">
                        <center><h2 style = "color:white"><a href="https://www.instagram.com/ariorizkialfariz" style="color:white">Ario</a></h2></center>
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/amelia.jpeg')}}" title="Amelia" class="rounded img-responsive" style="cursor: pointer;">
                        <center><h2 style = "color:white"><a href="https://www.instagram.com/ariorizkialfariz" style="color:white">Amelia</a></h2></center>
                    </div>
                    <div class="col-md-2">
                        <img src="{{ asset('images/kelompok/fikri.jpeg')}}" title="Fikri" class="rounded img-responsive" style="cursor: pointer;">
