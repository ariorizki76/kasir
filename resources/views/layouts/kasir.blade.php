                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('images/profil')}}/@yield('foto_kasir')" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="{{URL('kasir/pengaturan')}}"><i class="ti-user"></i> Profile</a></li>
                                    <li><a href="{{URL('kasir/logout')}}"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav" style="background: #faebcd">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('kasir') ? 'active' : '')}}}"> <a href="{{URL('kasir')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard</a></li>

                        <li class="{{{(Request::is('kasir/pemesanan') ? 'active' : '')}}}"> <a href="{{URL('kasir/pemesanan')}}" aria-expanded="false"><i class="fa fa-list-ul"></i>Pemesanan</a></li>

                        <li class="{{{(Request::is('kasir/hidangan') ? 'active' : '')}}}"> <a href="{{URL('kasir/hidangan')}}" aria-expanded="false"><i class="fa fa-fire"></i>Hidangan</a></li>
                    
                        <li class="{{{(Request::is('kasir/pengaturan') ? 'active' : '')}}}"> <a href="{{URL('kasir/pengaturan')}}" aria-expanded="false"><i class="fa fa-gears"></i>Profil</a></li>
                    </ul>
                </nav>
