                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('images/profil')}}/@yield('foto_owner')" alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="{{URL('owner/pengaturan')}}"><i class="ti-user"></i> Profile</a></li>
                                    <li><a href="{{URL('owner/logout')}}"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav" style="background: #faebcd">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{{(Request::is('owner') ? 'active' : '')}}}"> <a href="{{URL('owner')}}" aria-expanded="false"><i class="fa fa-tachometer"></i>Dashboard</a></li>

                        <li class="{{{(Request::is('owner/hidangan') ? 'active' : '')}}}"> <a href="{{URL('owner/hidangan')}}" aria-expanded="false"><i class="fa fa-fire"></i>Hidangan</a></li>
                    
                        <li class="{{{(Request::is('owner/pengaturan') ? 'active' : '')}}}"> <a href="{{URL('owner/pengaturan')}}" aria-expanded="false"><i class="fa fa-gears"></i>Profil</a></li>
                    </ul>
                </nav>
