...
<head>
    ...
    <title>@yield('title') - Kasir | Kelompok 1</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer" style="text-align: center"> © 2021 All rights reserved. Kelompok 1 <a href="https://colorlib.com">Colorlib</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
