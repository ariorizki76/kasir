...
@section('content')
                        ...
                        <div class="card p-30" style="background: #f5f5f5">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <a href="{{URL('pelanggan/pengaturan')}}"><h2 style="color: #5e493a">{{$pelanggan['nama_pelanggan']}}</h2></a>
                                    <p class="m-b-0">Nama Pelanggan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <script type="text/javascript">
                    swal("Hey, {{$pelanggan['nama_pelanggan']}}", "Selamat datang di dashboard Ini Cafe!", "success")
                </script>
