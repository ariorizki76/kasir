                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                <h4>Register</h4>
                                <form method="POST" action="{{URL('waiter/register')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="register-link m-t-15 text-center">
                                        <p>Already have an account?<a href="{{URL('waiter/login')}}"> Login Here</a></p>
                                    </div>
